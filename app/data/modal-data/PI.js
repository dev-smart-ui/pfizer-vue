window.PI = {
  ...
  textUnderQrCenter: `To access the XELJANZ (tofacitinib citrate) Austrian prescribing information,<sup>1</sup> please scan this QR code`,
  textUnderQrRight: `To access the XELJANZ (tofacitinib citrate) EU label,<sup>2</sup> please scan this QR code`,
  content: `<strong>Qualitative und quantitative Zusammensetzung:</strong> <em>XELJANZ 5 mg Filmtabletten, XELJANZ 10 mg Filmtabletten:</em> Jede Filmtablette enthält Tofacitinibcitrat, entsprechend 5 mg bzw. 10 mg Tofacitinib. Sonstiger Bestandteil mit bekannter Wirkung: Jede Filmtablette enthält 59,44 mg bzw. 118,88mg Lactose. <em>XELJANZ 11 mg Retardtabletten:</em> Jede Retardtablette enthält Tofacitinibcitrat, entsprechend 11 mg Tofacitinib. Sonstiger Bestandteil mit bekannter Wirkung: Jede Retardtablette enthält 152,23mg Sorbitol. 
<em>XELJANZ 1 mg/ml Lösung zum Einnehmen:</em>  Jeder ml Lösung zum Einnehmen enthält Tofacitinibcitrat, entsprechend 1 mg Tofacitinib. Sonstige Bestandteile mit bekannter Wirkung: Jeder ml Lösung zum Einnehmen enthält 2,39 mg Propylenglycol und 0,9 mg Natriumbenzoat.
...
<br/><strong>1.</strong> XELJANZ [fachkurzinformation]. Pfizer Ltd; July 2022; <strong>2.</strong> XELJANZ (tofacitinib citrate) Summary of Product Characteristics. Brussels, Belgium: Pfizer Ltd; July 2022.`,
};
